...
//            val cameraList = filterCompatibleCameras(cameraManager.cameraIdList, cameraManager)
    ...
    /**
     * get next camera including external camera
     */
...
//                }
                ...
                availableCameras.add(
                    FormatItem(
                        "$orientation ($id)", id, ImageFormat.JPEG
                    )
                )
